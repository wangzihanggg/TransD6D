...
class SwinDePose(nn.Module):
    def __init__(
        ...
        self.rgbd_seg_layer = (
            ...
            .conv1d(128, bn=True, activation=nn.ReLU())
        # self.patch_embed = self.swin_ffb.patch_embed()
        # self.use_abs_pos_embed = self.swin_ffb.use_abs_pos_embed
        # if self.use_abs_pos_embed:
        #     patch_row = self.swin_ffb.pretrain_img_size[0] // self.swin_ffb.patch_size
        #     patch_col = self.swin_ffb.pretrain_img_size[1] // self.swin_ffb.patch_size
        #     num_patches = patch_row * patch_col
        #     self.absolute_pos_embed = nn.Parameter(
        #         torch.zeros((1, num_patches, self.swin_ffb.embed_dims)))
            .conv1d(128, bn=True, activation=nn.ReLU())
    ...
    def forward(
        ...
        rgbd_segs = self.rgbd_seg_layer(rgbd_emb) # (1, 128, 19200)
